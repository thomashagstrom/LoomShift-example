 ...
 * {@link AnimatedMenu} and defaults to `'grow'` — the preset that mirrors MUI's
 * own default `Grow` transition, so swapping it in changes nothing about where
 * the menu grows from.
 */
export type AnimatedMenuVariant = 'fade' | 'grow' | 'slide-up' | 'slide-down';
